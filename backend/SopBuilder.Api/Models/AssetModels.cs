...
public class Asset
{
    ...
    public string AssetType { get; set; } = AssetTypes.Document;
    ...
    /// <summary>External URL for linked assets</summary>
    ...
    /// <summary>Organizational category</summary>
...
{
    /// <summary>Base64-encoded file data, optionally with data URL prefix</summary>
