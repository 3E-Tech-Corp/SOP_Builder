...
import { loadSOP } from '../../utils/storage';
...
export default function SopTester() {
  ...
  const [bottomTab, setBottomTab] = useState('actions'); // 'actions' | 'audit'
        ...
        <div className="px-3 py-2.5 border-b border-slate-700">
          <div className="flex items-center gap-2 mb-2">
            ...
            <button
              ...
              className="text-slate-400 hover:text-synthia-400 transition-colors"
              title="Edit SOP"
            >
          ...
          <div className="px-3 py-2 border-b border-slate-700 bg-slate-800/80">
            ...
            <div className="flex gap-1">
              <button
                ...
                className="flex-1 px-2 py-1 text-[10px] font-medium text-white bg-synthia-600 rounded transition-colors"
              >
                Create
              </button>
              <button
                onClick={() => { setShowNewObject(false); setNewObjName(''); }}
